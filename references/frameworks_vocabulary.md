...
Named frameworks useful as **query anchors** during research. This file is a cheat sheet, not a tutorial — it exists so researchers have vocabulary for searches when a track stalls.

**Rule:** Don't try to apply any of these wholesale. Use them to sharpen queries ("what's their Sandler pain-impact layer?", "what's on the Forrester Wave for their category?"), then translate the findings back into the structures this skill produces (pain-point ranking, capability map, risk-with-political-layer).
...
Analyst evaluation reports for specific technology categories. Each Wave scores vendors on "current offering" + "strategy" + "market presence" with explicit strengths/weaknesses callouts.

**Use for:** competitive position research when vendor marketing copy is too generic. Analyst language is explicit about weaknesses in a way marketing copy never is.
**Query pattern:** "Forrester Wave [category] [year]"

### Gartner Magic Quadrant

Same function as Forrester Wave, different 2×2 axes (completeness of vision × ability to execute). Leaders / Challengers / Visionaries / Niche Players quadrants.

**Use for:** same as Forrester. Triangulate between both when possible — different analyst houses surface different weaknesses.
**Query pattern:** "Gartner Magic Quadrant [category] [year]"

### IDC MarketScape

Third major analyst house with a similar vendor-evaluation format. Often stronger in industry-specific categories (manufacturing, energy) than Forrester/Gartner.

**Query pattern:** "IDC MarketScape [category] [year]"
...
Strategic framework for industry dynamics: **competitive rivalry**, **threat of new entrants**, **threat of substitutes**, **supplier power**, **buyer power**.

**Use for:** competitive position research that's returning only direct-rivalry intel. Each force is a distinct query angle — e.g., "new entrants" often surfaces tech startups a traditional competitive scan misses.
